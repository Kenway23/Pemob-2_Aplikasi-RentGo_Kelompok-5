...
class DetailKendaraanPenyewa extends StatelessWidget {
  ...
  const DetailKendaraanPenyewa({
    super.key,
    required this.kendaraanId, required String vehicleId,
  });
  ...
  // ===========================
  Future<void> _bookingKendaraan(BuildContext context) async {
    try {
          ...
          children: [
            ...
            Container(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('IDR XXXXX / 1 Day',
                      style: TextStyle(fontWeight: FontWeight.bold)),
                  Text('3 unit tersedia',
            ...
            const Spacer(),
            _buildActionButton('Booking', const Color(0xFF8EBAE8), () async {
              Navigator.pop(context);
              await _bookingKendaraan(context);
            }),
            const SizedBox(height: 10),
          ],
        ),
    ...
    return Row(
      ...
      children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
          ...
          Text('A car with high specs at affordable price',
